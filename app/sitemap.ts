...
export default function sitemap(): MetadataRoute.Sitemap {
  const updated = new Date("2026-08-29T00:00:00+05:30");
  return [
    { url: siteUrl, lastModified: updated, changeFrequency: "monthly", priority: 1 },
    { url: `${siteUrl}/services`, lastModified: updated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${siteUrl}/about`, lastModified: updated, changeFrequency: "monthly", priority: 0.9 },
